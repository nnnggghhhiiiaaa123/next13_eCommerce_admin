...
```shell
git clone https://github.com/Cotchi666/next13_eCommerce_admin.git
```
...
- Check out for more [Mongo-Prisma doc](https://www.prisma.io/docs/reference/database-reference/connection-urls)
```js
